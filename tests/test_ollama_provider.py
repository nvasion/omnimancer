...
class TestOllamaProviderModelDiscovery:
    ...
    async def test_get_server_models_bad_status(self, ollama_provider):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(NetworkError, match="Failed to fetch models from Ollama server"):
                await ollama_provider._get_server_models()
    
    @pytest.mark.asyncio
    async def test_get_available_models_async_success(self, ollama_provider, mock_server_models):
...
class TestOllamaProviderCredentialValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_credentials_success(self, ollama_provider, mock_server_models):
...
class TestOllamaProviderMessageSending:
    ...
    @pytest.mark.asyncio
    async def test_send_message_success(self, ollama_provider, sample_chat_context, mock_successful_response):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            mock_client.return_value.__aenter__.return_value.get = AsyncMock(return_value=mock_tags_response)
            mock_client.return_value.__aenter__.return_value.post = AsyncMock(return_value=mock_chat_response)
    ...
    @pytest.mark.asyncio
    async def test_send_message_server_unavailable(self, ollama_provider, sample_chat_context):
    ...
    async def test_send_message_timeout(self, ollama_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(NetworkError, match="Request to Ollama server timed out"):
                await ollama_provider.send_message("Hello", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_model_not_found(self, ollama_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(ModelNotFoundError, match="Use 'ollama pull llama2' to download it"):
                await ollama_provider.send_message("Hello", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_empty_response(self, ollama_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_malformed_response(self, ollama_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_network_error(self, ollama_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(NetworkError, match="Network error connecting to Ollama"):
                await ollama_provider.send_message("Hello", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_unexpected_error(self, ollama_provider, sample_chat_context):
...
class TestOllamaProviderCustomConfiguration:
    ...
    @pytest.mark.asyncio
    async def test_custom_server_url_in_requests(self, custom_ollama_provider, sample_chat_context):
