...
from omnimancer.core.models import (
    ...
    MCPError, MCPToolError, MCPServerError
)
...
class TestMCPClient:
    ...
    @pytest.mark.asyncio
    async def test_client_connect_success(self, sample_mcp_server_config, mock_mcp_process):
    ...
    @pytest.mark.asyncio
    async def test_client_list_tools_success(self, sample_mcp_server_config, sample_tool_definitions):
    ...
    @pytest.mark.asyncio
    async def test_client_call_tool_success(self, sample_mcp_server_config, mock_mcp_process):
    ...
    @pytest.mark.asyncio
    async def test_client_call_tool_execution_error(self, sample_mcp_server_config, mock_mcp_process):
    ...
    @pytest.mark.asyncio
    async def test_client_health_check_healthy(self, sample_mcp_server_config, mock_mcp_process):
...
class TestMCPManager:
    ...
    async def test_manager_initialize_with_no_enabled_servers(self):
        ...
        config = MCPConfig(
            enabled=True,
            servers={"disabled_server": disabled_server}
        )
        manager = MCPManager(config)
    ...
    @pytest.mark.asyncio
    async def test_manager_get_available_tools(self, sample_mcp_config, sample_tool_definitions):
    ...
    async def test_manager_execute_tool_success(self, sample_mcp_config):
        ...
        mock_client.call_tool_with_retry.assert_called_once_with("calculate", {"expression": "6 * 7"})
    ...
    def test_manager_get_tools_by_server(self, sample_mcp_config, sample_tool_definitions):
...
class TestMCPErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_server_process_crash_during_operation(self, sample_mcp_server_config):
