...
def mock_health_monitor():
    ...
    monitor.check_all_providers_health = AsyncMock(return_value={
...
class TestEnhancedProviderFallback:
    ...
    @pytest.mark.asyncio
    async def test_successful_execution_no_fallback(self, fallback_manager, mock_core_engine):
    ...
    @pytest.mark.asyncio
    async def test_fallback_to_secondary_provider(self, fallback_manager, mock_core_engine):
    ...
    def test_circuit_breaker_functionality(self, fallback_manager):
        ...
        for _ in range(5):
            fallback_manager._record_failure(provider_name, FallbackReason.PROVIDER_ERROR, "Error")
    ...
    def test_provider_stats_tracking(self, fallback_manager):
        ...
        fallback_manager._record_failure(provider_name, FallbackReason.NETWORK_ERROR, "Network error")
    ...
    def test_provider_stats_summary(self, fallback_manager):
        ...
        fallback_manager._record_failure('secondary', FallbackReason.RATE_LIMIT, 'Rate limited')
    ...
    @pytest.mark.asyncio
    async def test_health_check_integration(self, fallback_manager, mock_health_monitor):
    ...
    def test_fallback_reason_enum(self):
        ...
        expected_reasons = [
            'provider_error', 'network_error', 'rate_limit',
            'quota_exceeded', 'model_unavailable', 'timeout',
            'health_check_failed'
        ]
