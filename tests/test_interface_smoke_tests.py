...
class TestInterfaceSmokeTests:
    ...
    def test_ui_methods_exist(self):
        ...
        ui_methods = [
            '_show_welcome', '_show_goodbye', '_show_help', '_show_status',
            '_show_error', '_show_success', '_show_warning', '_show_info',
            '_show_user_message', '_show_assistant_message', '_clear_screen'
        ]
        
        for method_name in ui_methods:
            assert hasattr(self.interface, method_name), f"Missing method: {method_name}"
    ...
    def test_command_handler_methods_exist(self):
        ...
        handler_methods = [
            '_handle_user_input', '_handle_chat_message', '_handle_slash_command',
            '_handle_system_command', '_handle_keyboard_interrupt'
        ]
    ...
    def test_completion_methods_exist(self):
        ...
        completion_methods = [
            '_complete_command', '_complete_slash_commands', 
            '_complete_command_arguments', '_complete_switch_command'
        ]
