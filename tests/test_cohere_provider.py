...
class TestCohereProviderModelInfo:
    ...
    def test_get_model_info_command_r(self):
        ...
        assert model_info.description == "Command R - Cohere's flagship conversational model"
    ...
    def test_get_model_info_command_r_plus(self):
        ...
        assert model_info.provider == "cohere"
        assert model_info.description == "Command R+ - Enhanced version with improved capabilities"
        assert model_info.max_tokens == 128000
    ...
    def test_get_model_info_command_light(self):
        ...
        assert model_info.provider == "cohere"
        assert model_info.description == "Command Light - Fast and efficient model for simple tasks"
    ...
    def test_get_model_info_command(self):
        ...
        assert model_info.provider == "cohere"
        assert model_info.description == "Command - Previous generation conversational model"
        assert model_info.max_tokens == 4096
...
class TestCohereProviderMessageSending:
    ...
    @pytest.mark.asyncio
    async def test_send_message_success(self, cohere_provider, sample_chat_context, mock_successful_response):
    ...
    @pytest.mark.asyncio
    async def test_send_message_authentication_error(self, cohere_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_rate_limit_error(self, cohere_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_model_not_found(self, cohere_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(ModelNotFoundError, match="Cohere model 'command-r' not found or not accessible"):
                await cohere_provider.send_message("Hello", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_bad_request_generic(self, cohere_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(ProviderError, match="Cohere API error: Invalid request format"):
                await cohere_provider.send_message("Hello", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_network_timeout(self, cohere_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_network_error(self, cohere_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_unexpected_error(self, cohere_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_malformed_json_response(self, cohere_provider, sample_chat_context):
...
class TestCohereChatHistoryPreparation:
    ...
    def test_prepare_chat_history_with_context(self, cohere_provider, sample_chat_context):
