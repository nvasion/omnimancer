...
class TestColorScheme:
    ...
    def test_custom_color_scheme(self):
        ...
        scheme = ColorScheme(
            risk_high="magenta", op_write="orange", diff_added="bright_green"
        )
...
class TestRichTextRenderer:
    ...
    def test_initialization_with_custom_components(self):
        ...
        renderer = RichTextRenderer(
            console=console, color_scheme=color_scheme, auto_detect=False
        )
    ...
    def test_render_table(self):
        ...
        rows = [["Agent 1", True, 42], ["Agent 2", False, 0], ["Agent 3", True, 15]]
    ...
    def test_render_risk_indicator(self):
        ...
        indicator = renderer.render_risk_indicator(
            RiskLevel.HIGH, show_label=True, show_bar=True
        )
        assert indicator is not None

        # Test with just label
        label_only = renderer.render_risk_indicator(
            RiskLevel.MEDIUM, show_label=True, show_bar=False
        )
        assert isinstance(label_only, Text)

        # Test with numeric risk
        numeric_indicator = renderer.render_risk_indicator(
            8, show_label=True, show_bar=True
        )
    ...
    def test_create_responsive_layout(self):
        ...
        sections = {"left": "Left content", "right": "Right content"}
    ...
    def test_render_shortcuts_help(self):
        ...
        shortcuts = {"q": "Quit", "h": "Help", "r": "Refresh"}
