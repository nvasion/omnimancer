...
class TestTemplateApplicator:
    ...
    def test_apply_template_with_force_application(
        ...
        applicator.validator.validate_persona = Mock(
            side_effect=[initial_validation, post_validation]
        )
    ...
    def test_apply_template_verification_failure(
        self, applicator, mock_persona_manager
    ):
    ...
    def test_activate_persona_with_switcher(
        self, applicator, mock_persona_manager, mock_agent_switcher
    ):
        ...
        mock_agent_switcher.switch_persona.assert_called_once_with(
            "test_persona", reason="Template application", force=False
        )

    def test_activate_persona_switcher_failure(
        self, applicator, mock_persona_manager, mock_agent_switcher
    ):
