...
class TestProposedChangesIntegration:
    ...
    def create_test_change(
        self, file_path="/test/file.py", operation_type=ChangeType.FILE_MODIFY
    ):
    ...
    async def test_fetch_proposed_changes_with_filter(self):
        ...
        change_set = await self.integration.fetch_proposed_changes(
            "op-002", file_paths=["/test/file1.py", "/test/file3.py"]
        )
    ...
    async def test_display_side_by_side_changes(self):
        ...
        with patch.object(
            self.integration.diff_renderer, "render_side_by_side_diff"
        ) as mock_render:
            await self.integration.display_side_by_side_changes(
    ...
    def test_get_change_statistics(self):
        ...
        change_set = ChangeSet(id="test", description="Test", changes=changes)
    ...
    def test_calculate_total_risk(self):
        ...
        changes = [
            ...
            ProposedChange(
                ...
                operation_type=ChangeType.FILE_DELETE,
    ...
    def test_create_risk_distribution_bar(self):
        ...
        risk_distribution = {"LOW": 5, "MEDIUM": 3, "HIGH": 1, "CRITICAL": 0}
