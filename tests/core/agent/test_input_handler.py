...
from omnimancer.core.agent.input_handler import (
    InteractiveInputHandler, InputMode, KeyAction, KeyBinding, InputState,
    create_input_handler, create_custom_input_handler,
    MINIMAL_KEY_BINDINGS, VIM_STYLE_KEY_BINDINGS, ARROW_KEY_BINDINGS
)
...
class TestInteractiveInputHandler:
    ...
    @patch('tty.setraw')
    async def test_terminal_setup_and_restore(self, mock_setraw, mock_tcsetattr, 
