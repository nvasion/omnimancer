...
class TestFileCreationIntegration:
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_new_file(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_user_approves(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_user_requests_backup(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_user_cancels(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_no_callback(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_callback_error(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_with_ui_callback(self, file_system_manager, temp_dir):
        ...
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask', return_value='1') as mock_prompt, \
             patch('omnimancer.core.agent.read_before_write_ui.Confirm.ask', return_value=True) as mock_confirm:
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_directory_exists(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_confirmation_symlink(self, file_system_manager, temp_dir):
...
class TestFileCreationWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_complete_workflow_new_project_files(self, file_system_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_complete_workflow_update_existing_project(self, file_system_manager, temp_dir):
        ...
        app_result = next(result for filename, result in results if filename == 'app.py')
        ...
        version_result = next(result for filename, result in results if filename == 'version.txt')
        ...
        new_file_result = next(result for filename, result in results if filename == 'new_feature.py')
