...
class TestAgentSwitcher:
    ...
    def test_switch_persona_with_current_active(
        self, agent_switcher, mock_persona_manager
    ):
    ...
    def test_state_persistence(
        self, agent_switcher, mock_persona_manager, temp_storage_path
    ):
    ...
    def test_state_restoration(self, agent_switcher, temp_storage_path):
        ...
        # Verify restoration
        coding_persona.set_session_data.assert_called_with(
    ...
    def test_rollback_on_failure(self, agent_switcher, mock_persona_manager):
        ...
        assert (
            mock_persona_manager.activate_persona.call_count == 2
...
class TestIntegration:
    ...
    def test_persona_state_preservation(
        self, real_agent_switcher, real_persona_manager
    ):
