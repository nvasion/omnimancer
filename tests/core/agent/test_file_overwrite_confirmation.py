...
class TestFileOverwriteConfirmation:
    ...
    async def test_confirm_file_overwrite_backup(self, ui):
        ...
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask', return_value='2'):
    ...
    async def test_confirm_file_overwrite_cancel(self, ui):
        ...
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask') as mock_prompt:
    ...
    async def test_confirm_file_overwrite_symlink(self, ui):
        ...
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask', return_value='3') as mock_prompt:
    ...
    async def test_confirm_file_overwrite_large_file(self, ui):
        ...
        # Mock user input to cancel
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask', return_value='3'):
    ...
    async def test_confirm_file_overwrite_hesitant_user(self, ui):
        ...
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask') as mock_prompt, \
             patch('omnimancer.core.agent.read_before_write_ui.Confirm.ask', return_value=False) as mock_confirm:
    ...
    async def test_confirm_file_overwrite_error_handling(self, ui):
        ...
        with patch('omnimancer.core.agent.read_before_write_ui.Prompt.ask', 
