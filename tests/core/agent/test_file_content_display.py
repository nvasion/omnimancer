...
class TestUnifiedFileContentDisplay:
    ...
    async def test_display_file_creation_interactive(self):
        ...
        with patch.object(self.display.unified_approval_ui, 'prompt_for_file_modification_approval') as mock_review:
    ...
    async def test_display_file_modification_with_diff(self):
        ...
        with patch.object(self.display.diff_renderer, 'render_unified_diff') as mock_diff:
