...
+    print("debug")
     return "world\""""
        ...
        renderables = renderer.render_diff_set(
            diff_text, diff_type=DiffType.SIDE_BY_SIDE
        )
...
+    print("debug")
     return "world\""""
        ...
        renderables = renderer.render_diff_set(
            diff_text, show_summary=False, show_file_tree=False
        )
    ...
    def test_render_file_content_comparison(self):
        ...
        panel = renderer.render_file_content_comparison(
            old_content, new_content, "test.py", language="python"
        )
...
class TestUtilityFunctions:
    ...
    def test_render_git_diff(self, mock_renderer_class):
        ...
        mock_renderer.render_diff_set.assert_called_once_with(
            diff_output, DiffType.UNIFIED
        )
