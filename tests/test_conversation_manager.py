...
class TestSaveConversation:
    ...
    def test_save_conversation_with_auto_filename(self, conversation_manager, sample_chat_context):
    ...
    def test_save_conversation_with_custom_filename(self, conversation_manager, sample_chat_context):
        """Test saving conversation with custom filename."""
        filename = conversation_manager.save_conversation(sample_chat_context, "my_conversation")
    ...
    def test_save_conversation_with_json_extension(self, conversation_manager, sample_chat_context):
        """Test saving conversation with .json extension already provided."""
        filename = conversation_manager.save_conversation(sample_chat_context, "test.json")
    ...
    def test_save_conversation_with_metadata(self, conversation_manager, sample_chat_context):
    ...
    def test_save_conversation_content_structure(self, conversation_manager, sample_chat_context):
        """Test that saved conversation has correct structure."""
        filename = conversation_manager.save_conversation(sample_chat_context, "structure_test")
    ...
    def test_save_conversation_file_error(self, conversation_manager, sample_chat_context):
        """Test handling of file write errors."""
        with patch('builtins.open', side_effect=IOError("Permission denied")):
            with pytest.raises(ConversationError, match="Failed to save conversation"):
                conversation_manager.save_conversation(sample_chat_context, "error_test")
...
class TestLoadConversation:
    ...
    def test_load_conversation_success(self, conversation_manager, sample_chat_context):
        ...
        filename = conversation_manager.save_conversation(sample_chat_context, "load_test")
        ...
        assert loaded_context.max_context_length == sample_chat_context.max_context_length
    ...
    def test_load_conversation_with_json_extension(self, conversation_manager, sample_chat_context):
    ...
    def test_load_conversation_invalid_version(self, conversation_manager):
        ...
        with pytest.raises(ConversationError, match="Unsupported conversation file version"):
...
class TestListConversations:
    ...
    def test_list_conversations_with_files(self, conversation_manager, sample_chat_context):
    ...
    def test_list_conversations_sorted_by_date(self, conversation_manager, sample_chat_context):
    ...
    def test_list_conversations_skips_invalid_files(self, conversation_manager, sample_chat_context):
...
class TestDeleteConversation:
    ...
    def test_delete_conversation_success(self, conversation_manager, sample_chat_context):
        """Test successful conversation deletion."""
        # Save conversation
        filename = conversation_manager.save_conversation(sample_chat_context, "delete_test")
    ...
    def test_delete_conversation_with_json_extension(self, conversation_manager, sample_chat_context):
    ...
    def test_delete_conversation_permission_error(self, conversation_manager, sample_chat_context):
        """Test handling permission errors during deletion."""
        # Save conversation
        filename = conversation_manager.save_conversation(sample_chat_context, "perm_test")
...
class TestGetConversationInfo:
    ...
    def test_get_conversation_info_success(self, conversation_manager, sample_chat_context):
    ...
    def test_get_conversation_info_with_json_extension(self, conversation_manager, sample_chat_context):
...
class TestExportConversation:
    ...
    def test_export_conversation_json(self, conversation_manager, sample_chat_context):
        ...
        # Save conversation
        filename = conversation_manager.save_conversation(sample_chat_context, "export_json_test")
        
        # Export to JSON (should return original file path)
        export_path = conversation_manager.export_conversation("export_json_test", "json")
    ...
    def test_export_conversation_markdown(self, conversation_manager, sample_chat_context):
    ...
    def test_export_conversation_unsupported_format(self, conversation_manager, sample_chat_context):
        """Test exporting to unsupported format."""
        # Save conversation
        conversation_manager.save_conversation(sample_chat_context, "export_unsupported_test")
...
class TestPrivateMethods:
    ...
    def test_export_to_txt_content(self, conversation_manager, sample_chat_context):
        ...
        export_path = conversation_manager._export_to_txt(sample_chat_context, "test_txt")
    ...
    def test_export_to_markdown_content(self, conversation_manager, sample_chat_context):
        """Test Markdown export content formatting."""
        export_path = conversation_manager._export_to_markdown(sample_chat_context, "test_md")
...
class TestEdgeCases:
    ...
    def test_special_characters_in_content(self, conversation_manager):
        ...
        filename = conversation_manager.save_conversation(context, "special_chars_test")
