...
from omnimancer.core.models import ChatContext, ChatMessage, MessageRole, EnhancedModelInfo
...
class TestPerplexityProviderMessageSending:
    ...
    @pytest.mark.asyncio
    async def test_send_message_success(self, perplexity_provider, sample_chat_context, mock_successful_response):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            response = await perplexity_provider.send_message("What's the weather today?", sample_chat_context)
            
            assert response.content == "Based on current weather data, it's sunny with 75°F temperature."
            assert response.model_used == "llama-3.1-sonar-small-128k-online"
            assert response.tokens_used == 45
            assert response.timestamp is not None
    
    @pytest.mark.asyncio
    async def test_send_message_with_citations(self, perplexity_provider, sample_chat_context, mock_successful_response_with_metadata):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            response = await perplexity_provider.send_message("Tell me about AI advances", sample_chat_context)
    ...
    @pytest.mark.asyncio
    async def test_send_message_online_model_parameters(self, perplexity_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_offline_model_no_search_params(self, offline_perplexity_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            await offline_perplexity_provider.send_message("Test message", sample_chat_context)
    ...
    async def test_send_message_timeout(self, perplexity_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(NetworkError, match="Request to Perplexity API timed out"):
                await perplexity_provider.send_message("Test message", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_network_error(self, perplexity_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_authentication_error(self, perplexity_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_rate_limit_error(self, perplexity_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(RateLimitError, match="Perplexity API rate limit exceeded"):
                await perplexity_provider.send_message("Test message", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_model_not_found(self, perplexity_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(ModelNotFoundError, match="Perplexity model .* not found"):
                await perplexity_provider.send_message("Test message", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_empty_response(self, perplexity_provider, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            with pytest.raises(ProviderError, match="Empty response from Perplexity API"):
                await perplexity_provider.send_message("Test message", sample_chat_context)
    
    @pytest.mark.asyncio
    async def test_send_message_unexpected_error(self, perplexity_provider, sample_chat_context):
...
class TestPerplexityProviderModelInfo:
    ...
    def test_get_model_info_online_model(self, perplexity_provider):
        ...
        assert model_info.description == "Llama 3.1 Sonar Small with real-time web search"
...
class TestPerplexityProviderMessagePreparation:
    ...
    def test_prepare_messages_with_context(self, perplexity_provider, sample_chat_context):
        """Test preparing messages with conversation context."""
        messages = perplexity_provider._prepare_messages("New message", sample_chat_context)
        ...
        assert messages[1]["content"] == "I can help you check the weather. What location are you interested in?"
...
class TestPerplexityProviderResponseHandling:
    ...
    def test_handle_response_success(self, perplexity_provider, mock_successful_response):
    ...
    def test_handle_response_with_error_json(self, perplexity_provider):
        ...
        with pytest.raises(ProviderError, match="Perplexity API error: Invalid request format"):
