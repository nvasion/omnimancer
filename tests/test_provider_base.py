...
class ProviderTestBase(ABC):
    ...
    async def test_send_message_success(self, sample_chat_context, mock_successful_response):
        """Test successful message sending."""
        provider = self.get_provider_instance()
        
        with patch('httpx.AsyncClient.post', return_value=mock_successful_response) as mock_post:
    ...
    async def test_send_message_authentication_error(self, sample_chat_context, mock_auth_error_response):
    ...
    async def test_send_message_rate_limit_error(self, sample_chat_context, mock_rate_limit_response):
    ...
    async def test_send_message_model_not_found(self, sample_chat_context, mock_model_not_found_response):
        """Test handling of model not found errors."""
        provider = self.get_provider_instance()
        
        with patch('httpx.AsyncClient.post', return_value=mock_model_not_found_response):
