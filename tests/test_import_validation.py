...
class TestCoreModuleImports:
    ...
    def test_provider_imports(self):
        ...
        providers = [
            'claude', 'openai', 'gemini', 'ollama', 'cohere',
            'azure', 'bedrock', 'claude_code', 'mistral',
            'openrouter', 'perplexity', 'vertex', 'xai'
        ]
        ...
        for provider_name in providers:
            ...
            try:
                ...
                assert provider_module is not None, f"Provider {provider_name} should import successfully"
...
class TestModuleIntegrity:
    ...
    def test_no_circular_imports(self):
        ...
        for module_name in modules_to_test:
            try:
                ...
                assert module is not None, f"Module {module_name} should import without circular dependencies"
            except ImportError as e:
    ...
    def test_all_exports_accessible(self):
        ...
        for export_name in error_exports:
            try:
                ...
                assert export_class is not None, f"Export {export_name} should be accessible"
    ...
    def test_critical_paths_working(self):
        ...
        try:
            from omnimancer.core.security.sandbox_manager import SandboxManager, ResourceLimits, SandboxedProcess
            from omnimancer.core.security.approval_workflow import ApprovalWorkflow, RiskLevel
            from omnimancer.utils.errors import SecurityError, ExecutionError, TimeoutError
    ...
    def test_required_dependencies_available(self):
        ...
        for package_name, import_name in required_deps.items():
            try:
                ...
                pytest.fail(f"Required dependency {package_name} (import as {import_name}) is not available")
