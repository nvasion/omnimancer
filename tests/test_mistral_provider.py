...
from omnimancer.core.models import ChatContext, ChatMessage, MessageRole, EnhancedModelInfo, ToolDefinition, ToolCall
...
class TestMistralProviderMessageSending:
    ...
    @pytest.mark.asyncio
    async def test_send_message_success(self, mistral_provider, sample_chat_context, mock_successful_response):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            response = await mistral_provider.send_message("Explain ML types", sample_chat_context)
            
            assert response.content == "Machine learning algorithms can be categorized into supervised, unsupervised, and reinforcement learning."
            assert response.model_used == "mistral-large-latest"
            assert response.tokens_used == 45
            assert response.timestamp is not None
    
    @pytest.mark.asyncio
    async def test_send_message_with_safety_settings(self, mistral_provider_safe, sample_chat_context):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            await mistral_provider_safe.send_message("Test message", sample_chat_context)
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_json_format(self, mistral_provider_json, sample_chat_context):
        """Test message sending with JSON response format."""
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "choices": [{"message": {"role": "assistant", "content": '{"result": "JSON response"}'}}],
    ...
    @pytest.mark.asyncio
    async def test_send_message_network_error(self, mistral_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_authentication_error(self, mistral_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_rate_limit_error(self, mistral_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_model_not_found(self, mistral_provider, sample_chat_context):
    ...
    @pytest.mark.asyncio
    async def test_send_message_empty_response(self, mistral_provider, sample_chat_context):
...
class TestMistralProviderToolCalling:
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_tools_success(self, mistral_provider, sample_chat_context, sample_tools, mock_tool_response):
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_tools_payload_format(self, mistral_provider, sample_chat_context, sample_tools):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            await mistral_provider.send_message_with_tools("Test message", sample_chat_context, sample_tools)
            ...
            assert tools[0]['function']['description'] == 'Execute Python code and return results'
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_tools_and_safety(self, mistral_provider_safe, sample_chat_context, sample_tools):
        """Test tool calling with safety settings."""
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {
            "choices": [{"message": {"role": "assistant", "content": "Safe tool response"}}],
            "usage": {"total_tokens": 15}
        }
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            await mistral_provider_safe.send_message_with_tools("Test message", sample_chat_context, sample_tools)
    ...
    @pytest.mark.asyncio
    async def test_convert_tools_to_mistral_format(self, mistral_provider, sample_tools):
        ...
        assert tool1['function']['description'] == 'Execute Python code and return results'
...
class TestMistralProviderModelInfo:
    ...
    def test_get_model_info_large_model(self, mistral_provider):
        ...
        assert model_info.description == "Mistral Large - Most capable model for complex tasks"
    ...
    def test_get_model_info_codestral(self):
        ...
        assert model_info.description == "Codestral - Specialized for code generation and analysis"
...
class TestMistralProviderMessagePreparation:
    ...
    def test_prepare_messages_with_context(self, mistral_provider, sample_chat_context):
        ...
        messages = mistral_provider._prepare_messages("New message", sample_chat_context)
        ...
        assert messages[1]["content"] == "Machine learning is a subset of AI that enables systems to learn from data."
...
class TestMistralProviderResponseHandling:
    ...
    def test_handle_response_with_tools_success(self, mistral_provider, mock_tool_response):
    ...
    def test_handle_response_with_error_json(self, mistral_provider):
        ...
        with pytest.raises(ProviderError, match="Mistral API error: Invalid request format"):
