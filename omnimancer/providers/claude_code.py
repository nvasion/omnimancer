...
class ClaudeCodeProvider(BaseProvider):
    ...
    def __init__(self, api_key: str = "local", model: str = "", **kwargs):
        ...
        self.claude_code_mode = kwargs.get('claude_code_mode', self._extract_mode_from_model())
    ...
    def _validate_installation(self):
        ...
        try:
            ...
            if result.returncode != 0:
                ...
                if result.returncode != 0:
                    raise ProviderError(f"Claude command not found or not working at: {self.claude_code_path}")
    ...
    async def _execute_claude_code(self, conversation: str) -> subprocess.CompletedProcess:
        """
    ...
    def _handle_claude_code_response(self, result: subprocess.CompletedProcess) -> ChatResponse:
        """
        ...
        if result.returncode == 0:
            ...
            if "authentication" in error_msg.lower() or "api key" in error_msg.lower():
                raise AuthenticationError(f"Claude-code authentication error: {error_msg}")
