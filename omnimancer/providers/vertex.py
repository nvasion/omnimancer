...
class VertexAIProvider(BaseProvider):
    ...
    def _setup_authentication(self):
        ...
        if self.service_account_path:
            ...
            try:
                ...
                raise ValueError("Either service_account_path or api_key must be provided for Vertex AI")
    ...
    async def send_message_with_tools(
        ...
        try:
            ...
            request_data = self._prepare_vertex_request_with_tools(message, context, available_tools)
    ...
    def _prepare_vertex_request_with_tools(
        ...
        if tools:
            request_data["tools"] = [self._convert_tool_to_vertex_format(tool) for tool in tools]
    ...
    def supports_multimodal(self) -> bool:
        ...
        """
        multimodal_models = ["gemini-1.5-pro", "gemini-1.5-flash", "gemini-1.0-pro-vision"]
