...
class OpenRouterProvider(BaseProvider):
    ...
    def __init__(self, api_key: str, model: str = "", **kwargs):
        ...
        self.openrouter_referrer = kwargs.get('openrouter_referrer', 'https://github.com/omnimancer-cli')
    ...
    def _convert_tools_to_openrouter_format(self, tools: List[ToolDefinition]) -> List[Dict]:
        """
        ...
        if response.status_code == 200:
            ...
            if choices and len(choices) > 0:
                ...
                if model_used != self.model:
                    ...
                    logger.warning(f"OpenRouter model fallback: requested '{self.model}' but got '{model_used}'")
    ...
    def supports_multimodal(self) -> bool:
        ...
        """
        multimodal_models = [
            "claude-3", "claude-3.5", "gpt-4o", "gpt-4-vision", 
