...
class PerplexityProvider(BaseProvider):
    ...
    def __init__(self, api_key: str, model: str = "", **kwargs):
        ...
        """
        super().__init__(api_key, model or "llama-3.1-sonar-small-128k-online", **kwargs)
        self.max_tokens = kwargs.get('max_tokens', 4096)
        self.temperature = kwargs.get('temperature', 0.2)
        self.search_enabled = kwargs.get('search_enabled', True)
        self.search_recency_filter = kwargs.get('search_recency_filter', 'month')  # hour, day, week, month, year
