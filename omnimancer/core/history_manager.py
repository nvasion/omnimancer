...
class HistoryEntry:
    ...
    def __init__(self, command: str, timestamp: Optional[float] = None, 
...
class HistoryManager:
    ...
    def add_command(self, command: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    def get_session_commands(self, session_id: Optional[str] = None) -> List[HistoryEntry]:
        """
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'sessions': len(set(entry.session_id for entry in self._history if entry.session_id))
        }
