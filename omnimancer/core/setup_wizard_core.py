...
class SetupWizardCore:
    ...
    def __init__(self, config_manager: ConfigManager, provider_registry: ProviderRegistry):
        ...
        self.provider_info = {
            "claude": {
                ...
                "strengths": ["Code analysis", "Complex reasoning", "Safety-focused", "Long conversations"],
            ...
            "openai": {
                ...
                "strengths": ["General purpose", "Code generation", "Creative writing", "Tool usage"],
                "models": ["gpt-4o", "o1", "o3", "o3-mini", "o4-mini", "o1-mini", "o1-pro", "gpt-4o-mini"],
            ...
            "gemini": {
                ...
                "strengths": ["Multimodal", "Large context", "Fast responses", "Google integration"],
                "models": ["gemini-2.5-pro-preview-05-06", "gemini-2.5-flash-preview-04-17", "gemini-2.0-flash", "gemini-1.5-pro"],
            ...
            "perplexity": {
                ...
                "strengths": ["Web search", "Real-time info", "Research", "Current events"],
                "models": ["sonar-pro", "sonar", "deep-research", "sonar-reasoning-pro", "sonar-reasoning"],
            ...
            "xai": {
                ...
                "strengths": ["Real-time data", "Reasoning", "Multimodal", "Tool usage"],
            ...
            "mistral": {
                ...
                "strengths": ["Efficiency", "Multilingual", "Code generation", "Privacy-focused"],
                "models": ["mistral-small-3.1", "mistral-medium", "mistral-large"],
                "api_key_url": "https://console.mistral.ai/",
                "api_key_prefix": "mistral-",
                "setup_notes": "Get your API key from the Mistral Console"
            },
            "cohere": {
                "name": "Cohere",
                "description": "Enterprise-focused AI with strong text generation",
                "strengths": ["Enterprise features", "Text generation", "Embeddings", "Classification"],
            ...
            "ollama": {
                ...
                "strengths": ["Privacy", "No API costs", "Offline usage", "Custom models"],
                "models": ["llama3.3:latest", "qwen3:latest", "mistral-small3.1:latest", "phi4:latest", "devstral:latest"],
            ...
            "azure": {
                ...
                "strengths": ["Enterprise security", "Azure integration", "Compliance", "Scalability"],
            ...
            "vertex": {
                ...
                "strengths": ["Enterprise features", "Google Cloud integration", "MLOps", "Custom models"],
            ...
            "bedrock": {
                ...
                "strengths": ["AWS integration", "Multiple models", "Enterprise security", "Serverless"],
                "models": [
            ...
            "openrouter": {
                ...
                "strengths": ["Model variety", "Cost optimization", "Unified API", "Real-time switching"],
                "models": ["google/gemini-2.5-flash-preview-05-20", "openai/gpt-4.1", "openai/o3", "openai/o4-mini", "meta-llama/llama-4-maverick"],
            ...
            "claude-code": {
                ...
                "strengths": ["Free usage", "Local processing", "Development focus", "No API limits"],
    ...
    def get_common_setup_issues(self, provider_name: str) -> List[Dict[str, str]]:
        ...
        return common_issues.get(provider_name, [
            {
