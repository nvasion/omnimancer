...
from .performance_monitor import (
    PerformanceMonitor, PerformanceAlert, OptimizationSuggestion,
    AlertLevel, OptimizationType, get_performance_monitor
)
from .token_tracker import TokenUsageTracker, UsagePattern, get_token_tracker
from .metrics_collector import PerformanceMetricsCollector, get_metrics_collector, AggregationMethod
...
class AlertRule:
    ...
    def check_condition(self, current_value: float, context: Dict[str, Any]) -> bool:
        ...
        if (self.last_triggered and 
            datetime.now() - self.last_triggered < self.cooldown_period):
            return False
    ...
    def trigger_alert(self, current_value: float, context: Dict[str, Any]) -> PerformanceAlert:
    ...
    def _generate_suggested_actions(self, current_value: float, context: Dict[str, Any]) -> List[str]:
...
class TrendAnalyzer:
    ...
    def detect_trend(self, values: List[float], timestamps: List[datetime]) -> Dict[str, Any]:
    ...
    def detect_anomalies(self, values: List[float], sensitivity: float = 2.0) -> List[int]:
...
class OptimizationEngine:
    ...
    def _gather_analysis_context(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.performance_monitor:
                context["dashboard_data"] = self.performance_monitor.get_performance_dashboard_data()
            
            # Token usage data
            if self.token_tracker:
                context["token_summary_1h"] = self.token_tracker.get_usage_summary(timedelta(hours=1))
                context["token_summary_24h"] = self.token_tracker.get_usage_summary(timedelta(hours=24))
    ...
    def _evaluate_optimization_rules(self, context: Dict[str, Any]) -> List[OptimizationSuggestion]:
    ...
    def _evaluate_alert_rules(self, context: Dict[str, Any]) -> List[PerformanceAlert]:
        ...
        for rule in self.alert_rules.values():
            try:
                ...
                if metric_summary and rule.check_condition(metric_summary.value, context):
    ...
    def _handle_optimization_suggestion(self, suggestion: OptimizationSuggestion) -> None:
    ...
    def _suggest_cost_optimization(self, context: Dict[str, Any]) -> OptimizationSuggestion:
    ...
    def _suggest_token_optimization(self, context: Dict[str, Any]) -> OptimizationSuggestion:
    ...
    def _suggest_performance_improvement(self, context: Dict[str, Any]) -> OptimizationSuggestion:
    ...
    def add_optimization_handler(self, handler: Callable[[OptimizationSuggestion], None]) -> None:
    ...
    def get_current_suggestions(self, category: Optional[OptimizationCategory] = None) -> List[OptimizationSuggestion]:
...
def initialize_optimization_engine(auto_start: bool = True) -> OptimizationEngine:
    """Initialize optimization engine."""
