...
class InteractiveInputHandler:
    ...
    def add_key_binding(self, key: str, action: KeyAction, description: str, 
                        mode: InputMode = InputMode.NORMAL):
    ...
    async def _handle_help(self) -> bool:
        ...
        self.state.mode = InputMode.HELP if self.state.help_visible else InputMode.NORMAL
        return True
    ...
    def get_help_text(self) -> str:
        ...
        categories = {
            ...
            "Navigation": [KeyAction.NAVIGATE_UP, KeyAction.NAVIGATE_DOWN, 
                          KeyAction.NAVIGATE_LEFT, KeyAction.NAVIGATE_RIGHT,
                          KeyAction.PAGE_UP, KeyAction.PAGE_DOWN, KeyAction.HOME, KeyAction.END],
            "Display Control": [KeyAction.TOGGLE_DIFF, KeyAction.TOGGLE_DETAILS,
                               KeyAction.ZOOM_IN, KeyAction.ZOOM_OUT],
            "Utility": [KeyAction.HELP, KeyAction.SEARCH, KeyAction.COPY, KeyAction.EXPORT]
        }
...
def create_input_handler(timeout_seconds: Optional[int] = None) -> InteractiveInputHandler:
