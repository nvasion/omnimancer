...
class ReadBeforeWriteUI:
    ...
    async def review_file_modification(self, review_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _display_file_exists_warning(self, file_info: Dict[str, Any]):
        ...
        if file_info.get('modified_time'):
            warning_text.append(f"Last modified: {file_info['modified_time']}\n", style="white")
    ...
    async def _get_overwrite_decision(self, file_info: Dict[str, Any]) -> Dict[str, Any]:
...
def create_confirmation_callback(console: Optional[Console] = None):
    ...
    async def confirmation_callback(file_info: Dict[str, Any]) -> Dict[str, Any]:
