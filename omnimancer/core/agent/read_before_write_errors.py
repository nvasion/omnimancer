    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'context': {
                ...
                'recovery_attempted': self.context.recovery_attempted if self.context else False,
                'recovery_strategy': self.context.recovery_strategy.value if self.context and self.context.recovery_strategy else None,
                'recovery_success': self.context.recovery_success if self.context else None,
                'additional_context': self.context.additional_context if self.context else {}
            },
...
class ReadBeforeWriteErrorHandler:
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        for error in self.error_history:
            ...
            if error.context and error.context.recovery_strategy:
                ...
                recovery_counts[recovery_strategy] = recovery_counts.get(recovery_strategy, 0) + 1
        ...
        return {
            ...
            'recovery_success_rate': successful_recoveries / len(self.error_history) if self.error_history else 0
        }
    ...
    def set_recovery_strategy(self, 
                             error_type: ReadBeforeWriteErrorType, 
                             strategy: RecoveryStrategy):
...
def create_error_handler(enable_recovery: bool = True, log_errors: bool = True) -> ReadBeforeWriteErrorHandler:
    """
