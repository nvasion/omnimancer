...
from .persona import (
    AgentPersona, PersonaConfiguration, PersonaCapability, 
    PersonaCategory, PersonaStatus, PersonaManager
)
...
class PersonaValidator:
    ...
    def _validate_persona_structure(self, persona: AgentPersona, result: ValidationResult) -> None:
        """Validate basic persona structure."""
    ...
    def _validate_persona_configuration(self, config: PersonaConfiguration, result: ValidationResult) -> None:
        """Validate persona configuration."""
        ...
        if hasattr(config, 'temperature_override') and config.temperature_override is not None:
        ...
        if hasattr(config, 'max_tokens_override') and config.max_tokens_override is not None:
    ...
    def _validate_template_compatibility(self, template_id: str, config: PersonaConfiguration, result: ValidationResult) -> None:
    ...
    def _validate_capabilities(self, capabilities: Set[PersonaCapability], result: ValidationResult) -> None:
    ...
    def _validate_provider_compatibility(self, config: PersonaConfiguration, result: ValidationResult) -> None:
        """Validate provider compatibility."""
    ...
    def _validate_template_structure(self, template: ConfigTemplate, result: ValidationResult) -> None:
        """Validate template structure."""
    ...
    def _validate_template_providers(self, template: ConfigTemplate, result: ValidationResult) -> None:
    ...
    def _validate_template_models(self, template: ConfigTemplate, result: ValidationResult) -> None:
        """Validate template recommended models."""
        if not hasattr(template, 'recommended_models') or not template.recommended_models:
            result.add_issue(ValidationIssue(
                severity=ValidationSeverity.WARNING,
                category=ValidationCategory.TEMPLATE_STRUCTURE,
    ...
    def _is_model_available(self, provider_id: str, model_id: str) -> bool:
        ...
        try:
            ...
            available = (provider_id in basic_models and 
                        model_id in basic_models[provider_id])
