...
class UnifiedFileContentDisplay:
    ...
    async def display_file_creation(self,
                                   file_path: str,
                                   content: str,
        ...
        try:
            ...
            if self.config.truncate_large_files and len(content) > self.config.max_content_size:
    ...
    async def display_file_modification(self,
                                       file_path: str,
                                       current_content: str,
                                       new_content: str,
                                       operation_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    async def display_file_deletion(self,
                                   file_path: str,
                                   content: str,
                                   operation_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.config.display_mode == DisplayMode.PREVIEW:
                preview_lines = min(self.config.max_preview_lines, len(content.splitlines()))
            ...
            if operation_context and operation_context.get('interactive', True):
                ...
                confirmed = Confirm.ask("Are you sure you want to delete this file?", default=False)
    ...
    def _display_file_modification_summary(self, file_path: str, file_change: FileChange):
        ...
        if file_change.lines_added or file_change.lines_removed:
            info_text.append(f"Lines added: +{file_change.lines_added}\n", style="green")
            info_text.append(f"Lines removed: -{file_change.lines_removed}\n", style="red")
...
def create_file_content_display(console: Optional[Console] = None,
                               config: Optional[FileDisplayConfig] = None) -> UnifiedFileContentDisplay:
    """
