...
"""
    ...
    def _generate_model_table(self, provider_name: str, info: Dict[str, Any]) -> str:
        ...
        for model in models:
            ...
            if "haiku" in model or "flash" in model or "mini" in model or "light" in model or "fast" in model:
    ...
    def generate_all_setup_guides(self, output_dir: str) -> List[str]:
        ...
        for provider_name in self.provider_info.keys():
            ...
            try:
                ...
                self.console.print(f"[green]✅ Generated setup guide for {provider_name}: {guide_path}[/green]")
            except Exception as e:
                self.console.print(f"[red]❌ Failed to generate guide for {provider_name}: {e}[/red]")
