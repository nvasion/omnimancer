            ...
            if char == KeyCodes.ESC:
                ...
                try:
                    ...
                    if select.select([sys.stdin], [], [], 0.1)[0]:
                        ...
                        if seq.endswith('[') and select.select([sys.stdin], [], [], 0.1)[0]:
                            seq += sys.stdin.read(1)
                            if seq[-1] in '0123456789' and select.select([sys.stdin], [], [], 0.1)[0]:
                                seq += sys.stdin.read(1)
        ...
        try:
            ...
            if len(completions) == 1:
                ...
                if words:
                    ...
                    # Insert at cursor
                    self.current_line = completion + self.current_line[self.cursor_pos:]
    ...
    def completion_callback(text: str) -> List[str]:
        ...
        # File path completions
            ...
            try:
                ...
                completions.extend([os.path.basename(match) if os.path.isfile(match) 
        ...
        try:
            if hasattr(engine, 'config_manager') and engine.config_manager:
                ...
                completions.extend([name for name in provider_names if name.startswith(text)])
        except Exception:
            pass
