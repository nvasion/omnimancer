...
class ModelNotFoundError(ProviderError):
    ...
    def get_suggestions(self) -> list:
        ...
        for model in self.available_models:
            ...
            if (model_lower in model_lower_check or 
                model_lower_check in model_lower or
                any(part in model_lower_check for part in model_lower.split('-'))):
...
class ProviderUnavailableError(ProviderError):
    ...
    def __str__(self) -> str:
        ...
        if self.fallback_providers:
            fallback_text = ", ".join(str(provider) for provider in self.fallback_providers)
