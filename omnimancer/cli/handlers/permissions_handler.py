...
class PermissionsHandler:
    ...
    def _display_permissions_overview(
        ...
        overview_panel = Panel(
            "\n".join(overview_lines), title="🔒 Security Overview", border_style="blue"
        )
    ...
    def _get_audit_entries(
        self, limit: int, filter_type: Optional[str], date_filter: Optional[str]
    ) -> List[Dict]:
    ...
    def _show_learning_status(self) -> None:
        ...
        try:
            ...
            status_panel = Panel(
                status_content, title="🧠 Learning Status", border_style=border_style
            )
