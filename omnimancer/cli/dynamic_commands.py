...
class DynamicCommand:
    ...
    arguments: List[Dict[str, Any]] = field(default_factory=list)  # Argument definitions
...
class CommandRegistry:
    ...
    def get_completions_for_command(self, command_name: str, arg_position: int, text: str) -> List[str]:
        """
